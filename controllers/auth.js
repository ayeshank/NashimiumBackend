...
const Member = require("../models/schema.js");
...
const companyCalc = require("../models/companySchema.js");
...
router.post("/membersignup", async (req, res) => {
  ...
  const memberLoginRef = await Member.findOne({ memberno: refmno });
  ...
  Member.findOne({ email: email })
    ...
    .then((userExist) => {
      ...
      member
        .save()
        .then(() => {
          // signupmemberno=memberno;
          signuprefno = refmno;
          req.session.membersno = memberno;

          pCurrency(req, res); //Preffered Currency
          referralroute(req, res); //Referral Members List
          nMember(req, res); //New Member Route
...
const nMember = async (req, res) => {
  ...
  console.log("nm81 " + nm81);

  nm82 = parseFloat(nm20).toFixed(2);
  console.log(nm82); //100
  nm83 = (
    (parseFloat(nm26) +
      parseFloat(nm31) +
      parseFloat(nm36) +
  ...
  memberLogRoute(req, res); //MemberLog
  eightRoute(req, res); // CompanyLog
  nineRoute(req, res); //AUD Log
  tenRoute(req, res); //XNA Log

  // res.status(201).json({message:"New Member REGISTERED"});
  // }).catch((err)=>res.status(500).json({error:"Failed to registered new member log"}))
};

router.post("/newmember", nMember);

//*************************************************************************************************************************************
//members log inserting route

var memberlogdetail = [];

const memberLogRoute = async (req, res) => {
  const {
    date,
    memberno,
    refmno,
...
router.post("/memberlog", memberLogRoute);

//COMPANY LOG Register
const eightRoute = async (req, res) => {
  const {
    date,
    CMI,
    CRS,
...
router.post("/companylog", eightRoute);

//AUD LOG Register
const nineRoute = async (req, res) => {
...
router.post("/audlog", nineRoute);

//XNA LOG Register
const tenRoute = async (req, res) => {
  const {
    memberno,
    name,
    surname,
  ...
  try {
    ...
    if (memberLogin) {
      if (memberLogin.password === password) {
        ...
        //memberLoginno=req.session.membersno;
...
//**********************************************
//referral inserting route
const referralroute = async (req, res) => {
  const {
    memberno,
    rlvl1,
    rlvl2,
  ...
  ref.save();
  // var array = [];
  // const refxna=await Member.find({}).skip(1).sort({$natural:-1}).limit(12)
  // if(refxna.length < 12)
  // {
  //   if(refxna.length == 1)
  //   {
  //     var refxnaa2=await Member.find({}).skip(1).sort({$natural:-1}).limit(1);
  //     for(var i = 0; i < 12; i++)
  //     { var a = refxnaa2[0].memberno;array.push(a);}
  //     const ref= new referral({memberno:req.session.membersno,rlvl1:signuprefno,rlvl2:array[1],rlvl3:array[2],rlvl4:array[3],rlvl5:array[4],rlvl6:array[5],rlvl7:array[6],rlvl8:array[7],rlvl9:array[8],rlvl10:array[9],rlvl11:array[10],rlvl12:array[11]});
  //     ref.save();
  //   }
  //   else if(refxna.length == 2)
  //   {
  //     var refxnaa2=await Member.find({}).skip(1).sort({$natural:-1}).limit(2);
  //     for(var i = 0; i < 12; i++)
  //     {
  //       var g;
  //       if(i <= 1 ){ var a = refxnaa2[i].memberno;g=a; array.push(a);}
  //       else { array.push(g);console.log(array); }
  //     }
  //     const ref= new referral({memberno:req.session.membersno,rlvl1:signuprefno,rlvl2:array[1],rlvl3:array[2],rlvl4:array[3],rlvl5:array[4],rlvl6:array[5],rlvl7:array[6],rlvl8:array[7],rlvl9:array[8],rlvl10:array[9],rlvl11:array[10],rlvl12:array[11]});
  //     ref.save();
  //   }
  //   else if(refxna.length == 3)
  //   {
  //     var refxnaa2=await Member.find({}).skip(1).sort({$natural:-1}).limit(3);
  //     for(var i = 0; i < 12; i++)
  //     {
  //       var g;
  //       if(i <= 2 ){ var a = refxnaa2[i].memberno;g=a; array.push(a);}
  //       else { array.push(g);console.log(array); }
  //     }
  //     const ref= new referral({memberno:req.session.membersno,rlvl1:signuprefno,rlvl2:array[1],rlvl3:array[2],rlvl4:array[3],rlvl5:array[4],rlvl6:array[5],rlvl7:array[6],rlvl8:array[7],rlvl9:array[8],rlvl10:array[9],rlvl11:array[10],rlvl12:array[11]});
  //     ref.save();
  //   }
  //   else if(refxna.length == 4)
  //   {
  //     var refxnaa2=await Member.find({}).skip(1).sort({$natural:-1}).limit(4);
  //     for(var i = 0; i < 12; i++)
  //     {
  //       var g;
  //       if(i <= 3 ){ var a = refxnaa2[i].memberno;g=a; array.push(a);}
  //       else { array.push(g);console.log(array); }
  //     }
  //     const ref= new referral({memberno:req.session.membersno,rlvl1:signuprefno,rlvl2:array[1],rlvl3:array[2],rlvl4:array[3],rlvl5:array[4],rlvl6:array[5],rlvl7:array[6],rlvl8:array[7],rlvl9:array[8],rlvl10:array[9],rlvl11:array[10],rlvl12:array[11]});
  //     ref.save();
  //   }
  //   else if(refxna.length == 5)
  //   {
  //     var refxnaa2=await Member.find({}).skip(1).sort({$natural:-1}).limit(5);
  //     for(var i = 0; i < 12; i++)
  //     {
  //       var g;
  //       if(i <= 4 ){ var a = refxnaa2[i].memberno;g=a; array.push(a);}
  //       else { array.push(g);console.log(array); }
  //     }
  //     const ref= new referral({memberno:req.session.membersno,rlvl1:signuprefno,rlvl2:array[1],rlvl3:array[2],rlvl4:array[3],rlvl5:array[4],rlvl6:array[5],rlvl7:array[6],rlvl8:array[7],rlvl9:array[8],rlvl10:array[9],rlvl11:array[10],rlvl12:array[11]});
  //     ref.save();
  //   }
  //   else if(refxna.length == 6)
  //   {
  //     var refxnaa2=await Member.find({}).skip(1).sort({$natural:-1}).limit(6);
  //     for(var i = 0; i < 12; i++)
  //     {
  //       var g;
  //       if(i <= 5 ){ var a = refxnaa2[i].memberno;g=a; array.push(a);}
  //       else { array.push(g);console.log(array); }
  //     }
  //     const ref= new referral({memberno:req.session.membersno,rlvl1:signuprefno,rlvl2:array[1],rlvl3:array[2],rlvl4:array[3],rlvl5:array[4],rlvl6:array[5],rlvl7:array[6],rlvl8:array[7],rlvl9:array[8],rlvl10:array[9],rlvl11:array[10],rlvl12:array[11]});
  //     ref.save();
  //   }
  //   else if(refxna.length == 7)
  //   {
  //     var refxnaa2=await Member.find({}).skip(1).sort({$natural:-1}).limit(7);
  //     for(var i = 0; i < 12; i++)
  //     {
  //       var g;
  //       if(i <= 6 ){ var a = refxnaa2[i].memberno;g=a; array.push(a);}
  //       else { array.push(g);console.log(array); }
  //     }
  //     const ref= new referral({memberno:req.session.membersno,rlvl1:signuprefno,rlvl2:array[1],rlvl3:array[2],rlvl4:array[3],rlvl5:array[4],rlvl6:array[5],rlvl7:array[6],rlvl8:array[7],rlvl9:array[8],rlvl10:array[9],rlvl11:array[10],rlvl12:array[11]});
  //     ref.save();
  //   }
  //   else if(refxna.length == 8)
  //   {
  //     var refxnaa2=await Member.find({}).skip(1).sort({$natural:-1}).limit(8);
  //     for(var i = 0; i < 12; i++)
  //     {
  //       var g;
  //       if(i <= 7 ){ var a = refxnaa2[i].memberno;g=a; array.push(a);}
  //       else { array.push(g);console.log(array); }
  //     }
  //     const ref= new referral({memberno:req.session.membersno,rlvl1:signuprefno,rlvl2:array[1],rlvl3:array[2],rlvl4:array[3],rlvl5:array[4],rlvl6:array[5],rlvl7:array[6],rlvl8:array[7],rlvl9:array[8],rlvl10:array[9],rlvl11:array[10],rlvl12:array[11]});
  //     ref.save();
  //   }
  //   else if(refxna.length == 9)
  //   {
  //     var refxnaa2=await Member.find({}).skip(1).sort({$natural:-1}).limit(9);
  //     for(var i = 0; i < 12; i++)
  //     {
  //       var g;
  //       if(i <= 8 ){ var a = refxnaa2[i].memberno;g=a; array.push(a);}
  //       else { array.push(g);console.log(array); }
  //     }
  //     const ref= new referral({memberno:req.session.membersno,rlvl1:signuprefno,rlvl2:array[1],rlvl3:array[2],rlvl4:array[3],rlvl5:array[4],rlvl6:array[5],rlvl7:array[6],rlvl8:array[7],rlvl9:array[8],rlvl10:array[9],rlvl11:array[10],rlvl12:array[11]});
  //     ref.save();
  //   }
  //   else if(refxna.length == 10)
  //   {
  //     var refxnaa2=await Member.find({}).skip(1).sort({$natural:-1}).limit(10);
  //     for(var i = 0; i < 12; i++)
  //     {
  //       var g;
  //       if(i <= 9 ){ var a = refxnaa2[i].memberno;g=a; array.push(a);}
  //       else { array.push(g);console.log(array); }
  //     }
  //     const ref= new referral({memberno:req.session.membersno,rlvl1:signuprefno,rlvl2:array[1],rlvl3:array[2],rlvl4:array[3],rlvl5:array[4],rlvl6:array[5],rlvl7:array[6],rlvl8:array[7],rlvl9:array[8],rlvl10:array[9],rlvl11:array[10],rlvl12:array[11]});
  //     ref.save();
  //   }
  //   else if(refxna.length == 11)
  //   {
  //     var refxnaa2=await Member.find({}).skip(1).sort({$natural:-1}).limit(11);
  //     for(var i = 0; i < 12; i++)
  //     {
  //       var g;
  //       if(i <= 10 ){ var a = refxnaa2[i].memberno;g=a; array.push(a);}
  //       else { array.push(g);console.log(array); }
  //     }
  //     const ref= new referral({memberno:req.session.membersno,rlvl1:signuprefno,rlvl2:array[1],rlvl3:array[2],rlvl4:array[3],rlvl5:array[4],rlvl6:array[5],rlvl7:array[6],rlvl8:array[7],rlvl9:array[8],rlvl10:array[9],rlvl11:array[10],rlvl12:array[11]});
  //     ref.save();
  ...
  // else
  // {
  //   for(var i = 0; i < refxna.length; i++)
  //   {
  //       let a = refxna[i].memberno;
  //         array.push(a);
  //   }
  //   const ref= new referral({memberno:req.session.membersno,rlvl1:signuprefno,rlvl2:array[1],rlvl3:array[2],rlvl4:array[3],rlvl5:array[4],rlvl6:array[5],rlvl7:array[6],rlvl8:array[7],rlvl9:array[8],rlvl10:array[9],rlvl11:array[10],rlvl12:array[11]});
  //   ref.save()
...
router.post("/referral", referralroute);
...
router.get("/statement", async (req, res) => {
  ...
  console.log(req.session.membersno);
  console.log(typeof req.session.membersno);
...
router.post("/buysellroute", async (req, res) => {
  ...
  buysellrecord.save().then(() => {
    ...
    des = description;
    sixthRoute(req, res);
    seventhRoute(req, res);
    fifthRoute(req, res);
    //     res.status(201).json({message:"BuySell REGISTERED"});
    // }).catch((err)=>res.status(500).json({error:"Failed to registered BuySell log"})
  });
});

//COMPANY LOG
const sixthRoute = async (req, res) => {
  const {
    date,
    CMI,
    CRS,
...
router.post("/companylog", sixthRoute);

//AUD LOG
const fifthRoute = async (req, res) => {
  const aLog = new audLog({
    CRSA: "0.00",
    XBA: bsc15,
    XSA: bsc13,
...
router.post("/audlog", fifthRoute);

//XNA BUY SELL LOG
const seventhRoute = async (req, res) => {
...
router.post("/xnabuyselllog", seventhRoute);
...
const compnayinputsettingafterexe = async (req, res) => {
  const xna = await xnaLog.findOne({}).sort({ $natural: -1 });
  const aud = await audLog.findOne({}).sort({ $natural: -1 });
  const company = await companyLog.findOne({}).sort({ $natural: -1 });
  ...
  console.log(cai10);
  console.log(cai11);
  console.log("cai12 " + cai12);
  console.log("cai13 " + cai13);
  console.log("cai14 " + cai14);
  ...
  cpc.save().then(() => {
    twelveRoute(req, res);
    thirteenRoute(req, res);
    //   res.status(201).json({message:"Company REGISTERED"});
    // }).catch((err)=>res.status(500).json({error:"Failed to registered BuySell log"}))
  });
};
router.post("/companycalcroute", compnayinputsettingafterexe);
//*************************************************************************************************************************************************

//*************************************************************Company Calculation COMPANY LOG****************************************************
const twelveRoute = async (req, res) => {
  const {
    date,
    CMI,
    CRS,
...
router.post("/companylog", twelveRoute);
//*************************************************************************************************************************************************

//*************************************************************Company Calculation AUD LOG****************************************************
const thirteenRoute = async (req, res) => {
  const { date, CRSA, XBA, XSA, CPSA, audnet, audbal, xnabal, xnaaud } =
    req.body;
  const aLog = new audLog({
    CRSA: "0.00",
...
router.post("/audlog", thirteenRoute);
//*************************************************************************************************************************************************
...
//   const csl=await Member.find({memberno:searchMember})
//   console.log(csl)
//   res.json({csl});
// };
// router.get('/membersearchget',msg);
...
router.post("/compInpSetpost", async (req, res) => {
  ...
  cs.save()
    .then(() => {
      compnayinputsettingafterexe(req, res);
...
router.get("/prefferedCurrencyGET", pCurrencyGet);
